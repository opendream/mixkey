...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataDay.water_level'
        db.add_column(u'domain_dataday', 'water_level',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DataThirtyMinute.water_level'
        db.add_column(u'domain_datathirtyminute', 'water_level',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DataYear.water_level'
        db.add_column(u'domain_datayear', 'water_level',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DataTenMinute.water_level'
        db.add_column(u'domain_datatenminute', 'water_level',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Data.water_level'
        db.add_column(u'domain_data', 'water_level',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DataMonth.water_level'
        db.add_column(u'domain_datamonth', 'water_level',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DataWeek.water_level'
        db.add_column(u'domain_dataweek', 'water_level',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DataHour.water_level'
        db.add_column(u'domain_datahour', 'water_level',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataDay.water_level'
        db.delete_column(u'domain_dataday', 'water_level')

        # Deleting field 'DataThirtyMinute.water_level'
        db.delete_column(u'domain_datathirtyminute', 'water_level')

        # Deleting field 'DataYear.water_level'
        db.delete_column(u'domain_datayear', 'water_level')

        # Deleting field 'DataTenMinute.water_level'
        db.delete_column(u'domain_datatenminute', 'water_level')

        # Deleting field 'Data.water_level'
        db.delete_column(u'domain_data', 'water_level')

        # Deleting field 'DataMonth.water_level'
        db.delete_column(u'domain_datamonth', 'water_level')

        # Deleting field 'DataWeek.water_level'
        db.delete_column(u'domain_dataweek', 'water_level')

        # Deleting field 'DataHour.water_level'
        db.delete_column(u'domain_datahour', 'water_level')
